...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { cidade: @contato.cidade, email: @contato.email, estado: @contato.estado, info: @contato.info, nome: @contato.nome }
    end
  ...
  test "should update contato" do
    put :update, id: @contato, contato: { cidade: @contato.cidade, email: @contato.email, estado: @contato.estado, info: @contato.info, nome: @contato.nome }
    assert_redirected_to contato_path(assigns(:contato))
  end
